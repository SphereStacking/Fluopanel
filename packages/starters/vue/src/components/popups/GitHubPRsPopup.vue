...
<template>
  <div
    class="relative w-full h-full font-[-apple-system,BlinkMacSystemFont,'SF_Pro_Text',sans-serif] text-[13px] antialiased"
  >
    <!-- Glass background -->
    <div
    ...
    <div class="relative flex flex-col h-full rounded-xl overflow-hidden">
      ...
      <!-- Content -->
      <div class="flex-1 overflow-y-auto popup-scrollbar">
        <!-- Loading -->
        <div
